                                ...
                                <div>
                                    ...
                                    <ul class="flex c8vtj cyqqd cri0s chfzq">
                                        <li class="cved1 cri0s ce4il">
                                            <a class="flex items-center cvwie cosgb c33r0 cgnhv cq84g cb8zv ch4gv cuvgf" href="{{ route('account') }}">
                                        ...
                                        <li class="cved1 cri0s ce4il">
                                            <a class="flex items-center cq84g cb8zv ch4gv cuvgf" href="{{ route('notifications') }}">
