@php
    $title = 'Bright Ummah Academy - Articles';
@endphp
                    ...
                    <div class="bg-white c2vpa c1hly c5vqk clxb7">
                        ...
                        <div class="flex items-center cm3rx">
                            ...
                            <div class="flex items-center">
                                <!-- Like button -->
                                <button class="flex items-center mr-4 casia cz0f0 cmpw7 cdqku">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-heart mr-1">
