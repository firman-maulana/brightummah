...
<body class="dark:text-gray-400 cecbd c1ukq cyhlg c11jl cfh61">
    ...
    <main class="bg-white cecbd">

        <div class="flex cm84d">

            <!-- Content -->
            <div class="ccxtb c6btv">

                <div class="flex c524j cc38k cetff cav8x">
                    ...
                    <div class="c7jh9">
                        <div class="flex items-center cm3rx cnbwt cs7xl c3nk1 clbq0">
                            ...
                            <a class="block" href="{{ route('admin.programs') }}">
                                <img id="signin-logo" src="{{ asset('assets/img/logo/logo.png') }}" class="cwjz0" width="64" height="64">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="cr78y">
                                ...
                                <div>
                                    ...
                                    <div style="position: relative; display: inline-block; width: 100%;">
                                        <input id="password" name="password" class="caqf9 c6btv" type="password" required style="padding-right: 45px; width: 100%;">
                                        <button type="button" id="togglePassword" onclick="togglePasswordVisibility()" style="position: absolute; top: 50%; right: 12px; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #9CA3AF; padding: 0; display: flex; align-items: center; justify-content: center;">
                                            <svg id="eyeOpen" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-eye">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
                                                <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" />
                                            </svg>
                                            <svg id="eyeClosed" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-eye-off" style="display: none;">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            ...
            <!-- Image -->
            <div class="hidden ccxtb cyqqd cqdkw cq5bq cgky2 cli41" aria-hidden="true">
                <img class="ccrfs cfwu1 cav8x c6btv" src="{{ asset('assets/admin/img/auth-image.jpg') }}" width="760" height="1024" alt="Authentication image">
            </div>
