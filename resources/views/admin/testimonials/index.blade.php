                                ...
                                <tr>
                                    <td class="cq84g cyjcc cgn91 c9hxi c72q5">
                                        <div class="flex items-center text-gray-800">
                                                <img class="cpts2" src="{{ $testimonial->photo_url ?? asset('assets/admin/img/user-avatar-32.png') }}" width="40" height="40" alt="User" style="margin-right: 12px;">
                                    ...
                                    <td colspan="10" class="cyjcc cgn91 c9hxi c72q5">
                                        <div class="dark:text-gray-400 coulr cgk1f c1f2y c9j8s">
                                            ...
                                            <div class="mt-3 flex flex-wrap items-center cnnms" style="padding: 8px;">
                                                <div class="ctq43">
                                                    <a href="{{ route('admin.testimonials.approve', [$testimonial->id, $testimonial->slug]) }}" class="btn bg-white border-gray-200 text-gray-800 cc0oq cghq3 cspbm c0zkc c2vpa">
                                ...
                                <tr id="description-latest-{{ $testimonial->id }}" role="region" x-show="open === {{ $testimonial->id }}" x-cloak="">
                                    <td colspan="10" class="cyjcc cgn91 c9hxi c72q5">
                                        <div class="dark:text-gray-400 coulr cgk1f c1f2y c9j8s">
                                            ...
                                            <a href="{{ route('admin.testimonials.approve', [$testimonial->id, $testimonial->slug]) }}" class="bg-gray-900 cdj8c cg0jr ch8z9 cilvw cyn7a cnf4p">Approve</a>
                                        </div>
                                    </td>
                                </tr>
                                @empty
