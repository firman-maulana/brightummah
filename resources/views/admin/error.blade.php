...
<li>
    ...
    <main class="cbw8w">
                <div class="clu2m c6btv ch3yp clbq0 cxsfz cnbwt cs7xl">

                    <div class="ct8yz cuifd cn9uy">

                        <div class="clbq0 cydwr">
                            <div class="inline-flex cgd7w">
                                <img class="c1bco" src="{{ asset('assets/admin/img/error/notfound.svg') }}" width="176" height="176" alt="404 illustration">
                                <img class="hidden c2e1r" src="{{ asset('assets/admin/img/error/notfoundlight.svg') }}" width="176" height="176" alt="404 illustration dark">
                            </div>
                            <div class="cai6b">Hmm...this page doesn't exist. Try searching for something else!</div>
                            <a href="{{ route('admin.dashboard') }}" class="btn bg-gray-900 cyn7a ch8z9 cilvw cg0jr cdj8c">Back To Dashboard</a>
                        </div>
