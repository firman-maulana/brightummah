@php
    $title = 'Bright Ummah Academy - Feedback';
@endphp
                        ...
                        <div class="flex c2poy cwner cetff">
                            ...
                            <div class="flex border-gray-200 cghq3 c9zp2 cjq31 colxp cschv cu49b cws0k c8vtj cyqqd cnuel ctv3r cb2br cwlwv">
                                ...
                                <div>
                                    ...
                                    <ul class="flex c8vtj cyqqd cri0s chfzq">
                                        <li class="cved1 cri0s ce4il">
                                            <a class="flex items-center cq84g cb8zv ch4gv cuvgf" href="{{ route('admin.account') }}">
                                ...
                                <div>
                                    ...
                                    <ul class="flex c8vtj cyqqd cri0s chfzq">
                                        <li class="cved1 cri0s ce4il">
                                            <a class="flex items-center cvwie cosgb c33r0 cgnhv cq84g cb8zv ch4gv cuvgf" href="{{ route('admin.feedback') }}">
                                                ...
                                                <span class="text-sm text-violet-500 csvw7 c1k3n">Give Feedback</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="cbw8w">
                                ...
                                <div class="cmxzb c41yb">
                                    <div>
                                        <h2 class="text-gray-800 dark:text-gray-100 font-bold cbtcb cdiog">Give Feedback</h2>
                                        <div class="text-sm">Our product depends on customer feedback to improve the overall experience!</div>
                                    </div>

                                    <!-- Rate -->
                                    <section>
                                        <h3 class="text-gray-800 dark:text-gray-100 font-bold ce5fk clctu cai6b">How likely would you recommend us to a friend or colleague?</h3>
                                        <div class="cejsc c6btv">
                                            <div class="cm84d">
                                                <div class="cmr9m cvwbh cqdkw cw0sb cu1dd cooyq cocs8 c6btv" aria-hidden="true"></div>
                                                <ul class="flex cm3rx cm84d c6btv">
                                                    <li class="flex">
                                                        <button class="w-3 h-3 rounded-full bg-white ch7su c2vpa cdx0c ct7xr">
                                                            <span class="cn8jz">1</span>
                                                        </button>
                                                    </li>
                                                    <li class="flex">
                                                        <button class="w-3 h-3 rounded-full bg-white ch7su c2vpa cdx0c ct7xr">
                                                            <span class="cn8jz">2</span>
                                                        </button>
                                                    </li>
                                                    <li class="flex">
                                                        <button class="w-3 h-3 rounded-full ci0dd cjnnd ct7xr">
                                                            <span class="cn8jz">3</span>
                                                        </button>
                                                    </li>
                                                    <li class="flex">
                                                        <button class="w-3 h-3 rounded-full bg-white ch7su c2vpa cdx0c ct7xr">
                                                            <span class="cn8jz">4</span>
                                                        </button>
                                                    </li>
                                                    <li class="flex">
                                                        <button class="w-3 h-3 rounded-full bg-white ch7su c2vpa cdx0c ct7xr">
                                                            <span class="cn8jz">5</span>
                                                        </button>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="flex text-sm text-gray-500 dark:text-gray-400 cm3rx c6btv caf78 c7gr8">
                                                <div>Not at all</div>
                                    ...
                                    <!-- Tell us in words -->
                                    <section>
                                        <h3 class="text-gray-800 dark:text-gray-100 font-bold ce5fk clctu c6r0l">Tell us in words</h3>
                                        <!-- Form -->
                                        <label class="cn8jz" for="feedback">Leave a feedback</label>
                                        <textarea id="feedback" class="cn9r8 c071z c6btv" rows="4" placeholder="I really enjoy…"></textarea>
                                    </section>
                                </div>
